...
def run():
    ...
    img = Image.open('./Logo/RecruitEye.png')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                insert_data(resume_data['name'], resume_data['email'], str(resume_score), timestamp,
                            str(resume_data['no_of_pages']), rec_field, cand_level, str(resume_data['skills']),
        ...
        if st.button('Login'):
            if ad_user == 'Khushi' and ad_password == '28181':
